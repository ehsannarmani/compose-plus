    ...
    LazyVerticalGrid(
        ...
        item {
            LazyItem {
                ...
                Column(modifier=Modifier.fillMaxSize().fadeIn(delay = 700), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                    Text(
        ...
        item {
            LazyItem {
                var visible by rememberBoolState(true)
                Column(modifier=Modifier.fillMaxSize().scaleIn(delay = 1100), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                    Text(
                        text = "Hello compose plus!",
        ...
        item {
            LazyItem {
                var visible by rememberBoolState(true)
                Column(modifier=Modifier.fillMaxSize().fadeIn(delay = 1300), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
                    Text(
                        text = "Hello compose plus!",
